...
<html lang="en">
  ...
  <body>
    ...
    <h3 style="color: burlywood">Topman skinny chino pants in stone</h3>
  ...
  <p><span style="color: rgb(214, 35, 202);">delivery status :</span> out for delivery</p>
  <h5 style="color: red">YOUR ORDER WILL BE DELIVERED SHORTLY</h5>
</div>
