...
<body>
    ...
    <script>
        function redirectToAnotherPage() {
            window.location.href = "<?php echo e(url('/trackingpage1')); ?>"; // Replace with your desired URL
        }
        function redirectTootherPage() {
            window.location.href = "<?php echo e(url('/trackingpage2')); ?>"; // Replace with your desired URL
        }
    </script>
</body>

</html><?php /**PATH D:\laravel\ordertracking\resources\views/welcome.blade.php ENDPATH**/ ?>